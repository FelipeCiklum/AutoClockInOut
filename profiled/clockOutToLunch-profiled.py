...
log_file = f"{folder}\\profiled\\logs\\clockouttolunch_profiled_log.txt"
...
logging.info("🕒 Esperando botón 'Clock out to lunch'...")
clock_in_button = wait.until(
    EC.element_to_be_clickable(
        (By.XPATH, "//a[.//span[normalize-space(text())='Out to Lunch']]")
    )
)
...
logging.info("✅ Clock out to lunch realizado correctamente.")
time.sleep(3)
driver.quit()